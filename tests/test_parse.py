...
class TestStringMethods(unittest.TestCase):
    ...
    def test_parse_GAAP10Q_RRDonnelley(self):
    ...
    def test_parse_GAAP10K_RRDonnelley(self):
    ...
    def test_parse_GAAP10K_Webfilings(self):
    ...
    def test_parse_GAAP10Q_Webfilings(self):
    ...
    def test_parse_GAAP10Q_Rivet(self):
    ...
    def test_parse_GAAP10K_Rivet(self):
    ...
    def test_parse_GAAP10Q_QXInteractive(self):
    ...
    def test_parse_GAAP10K_ThomsonReuters(self):
    ...
    def test_parse_GAAP10Q_Fujitsu(self):
    ...
    def test_parse_GAAP10K_Fujitsu(self):
    ...
    def test_parse_GAAP10Q_Ez_XBRL(self):
    ...
    def test_parse_DEI10Q_RRDonnelley(self):
    ...
    def test_parse_Custom10Q_RRDonnelley(self):
